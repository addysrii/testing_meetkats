      ...
      try {
        ...
        if (
          [
            ...
            "48hourmusic2025",
            "grabhack2025",
            "lorealsustainability2025",
            "accenturestrategyconnect4",
          ].includes(eventId)
        ) {
          let eventData;
          ...
          } else if (eventId === "lorealsustainability2025") {
            eventData = {
          ...
          } else if (eventId === "accenturestrategyconnect4") {
            eventData = {
