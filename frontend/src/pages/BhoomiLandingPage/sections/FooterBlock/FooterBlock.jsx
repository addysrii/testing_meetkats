      ...
      <Card style={{ backgroundColor: 'rgba(209, 224, 198, 1)' }} className="w-full border-none rounded-t-3xl shadow-none">
        <CardContent className="p-6 md:p-10 lg:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-10">
            ...
            <div className="flex flex-col space-y-4">
              <h3
                style={{ backgroundColor: "rgba(154, 190, 128, 1)" }}
                className="text-lg font-semibold text-green-800 w-fit px-2 py-1 rounded"
              >
                Contact us
              </h3>
              <div className="space-y-3">
                {contactInfo.map(({ label, value }) => (
                  <div key={label} className="text-green-800">
                    ...
                    {label === "Email" ? (
                      <a href={`mailto:${value}`} className="underline text-green-900 hover:text-green-600">
                        {value}
                      </a>
                    ) : (
                      value
